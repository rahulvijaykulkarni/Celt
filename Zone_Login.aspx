<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Zone_Login.aspx.cs" Inherits="Zone_Login" EnableEventValidation="false" %>
...
<body>
    ...
    <form id="form1" runat="server">
        ...
        <div class="container-fluid">
            ...
            <asp:Panel ID="Panel3" runat="server" CssClass="panel panel-primary" Style="background-color:#edeefe;border:none;">
                <div class="panel-heading">
                    <div class="row">
                        ...
                        <div class="col-sm-2">
                        <span><asp:Label ID="txt_usernam1" BackColor="#337ab7"  ForeColor="White" class="bg-primary" runat="server" CssClass="form-control" /> </span>  
                        </div>
                 ...
                 <div class="panel-body">
                      <div class="card acik-renk-form" style="height: 19em;border-radius:10px;">
                       ...
                       <asp:TextBox ID="txt_ddl_zone" runat="server"  Width="100%" class="form-control text_box" ></asp:TextBox>
                              </div>
                        <div class="col-sm-2 col-xs-12">
                        ...
                        <asp:UpdatePanel ID="UpdatePanel1" runat="server">
                            <ContentTemplate>
                                ...
                                <div class="col-sm-2 col-xs-12">
                                     <span style="font-weight:bold">State :</span><%--<span class="text-red"> *</span>--%>
                    ...
                    <asp:Panel runat="server" ID="tab_panel" CssClass="panel panel-primary" style="color:white;border:gray;" >
                       
                         <asp:Panel runat="server" ID="Panel1"   style="padding:10px;  background-color:#dddddd">
...
<asp:Panel runat="server" CssClass="grid-view">
                        ...
                        <Columns>
                            ...
                            <asp:BoundField HeaderText="Emp_Name" DataField="emp_code" SortExpression="emp_code" />
                        ...
                        <Columns>
                          ...
                          <div id="menu0" class="tab-pane fade in active">
                                    ...
                                    <ContentTemplate>--%>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-sm-2 col-xs-12">
                                                ...
                                                <asp:TextBox ID="txt_month_year" CssClass="form-control date-picker12" runat="server"></asp:TextBox>
                                            </div>
                                            <div class="col-sm-2 col-xs-12">
                                                <br />
                            ...
                            <div id="menu8" class="tab-pane">
                             ...
                             <div id="menu10" class="tab-pane" style="color:black">
                                <br />
